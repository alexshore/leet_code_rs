...
mod tests {
    ...
    #[test]
    fn case_1() {
        assert!(!Solution::can_construct("a".to_string(), "b".to_string())); // false
    }
    #[test]
    fn case_2() {
        assert!(!Solution::can_construct("aa".to_string(), "ab".to_string())); // false
    }
    #[test]
    fn case_3() {
        assert!(Solution::can_construct("aa".to_string(), "aab".to_string())); // true
    }
}
